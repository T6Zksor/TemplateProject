...
cmake .. -G "Visual Studio 16 2019" -A x64 -DCMAKE_PREFIX_PATH="D:\\Qt\\Qt5.12.1\\5.12.1\\msvc2017_64\\lib\\cmake" -DCMAKE_TOOLCHAIN_FILE="$PSScriptRoot/vcpkg/scripts/buildsystems/vcpkg.cmake"
cmake --build .
